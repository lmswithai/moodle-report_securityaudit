...
class cron extends \core\check\check {
    ...
    public function get_result(): result {
        ...
        if ($cronstatus->get_result()->get_status() != result::OK) {
            ...
            $summary = get_string('checkcronerror', 'report_securityaudit') . '<br>' . $cronstatus->get_result()->get_summary();
        } else {
            $status = result::OK;
            $summary = get_string('checkcronhok', 'report_securityaudit');
        }

        $details = get_string('checkcrondetails', 'report_securityaudit') . '<br>' . $cronstatus->get_result()->get_details();;
